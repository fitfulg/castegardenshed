...
export const USER_SESSION_EXPIRES_AT_KEY = "almacen_usuario_expira_en_v1";
...
export const REMOTE_OPTIONAL_FIELDS = ["seccion", "cantidad_comprobada", "modificado_por", "modificado_en"];
